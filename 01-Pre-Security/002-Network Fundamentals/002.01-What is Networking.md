...
- Networks = interconnected systems for communication and resource sharing.
- The Internet = a massive public network linking many private ones.
...
- **Ping (ICMP)** helps verify connectivity and measure network reliability.