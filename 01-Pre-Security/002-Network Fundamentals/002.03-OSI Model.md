...
Data is passed **from Layer 7 (Application)** down to **Layer 1 (Physical)**, gaining headers and formatting at each layer. When received, the process reverses — **de-encapsulation** — restoring the original data for the user.

## 🧠 **Key Takeaways**

- The OSI model helps isolate and troubleshoot network issues.
- Each layer serves a **distinct function** but works cooperatively.
- **TCP** = reliability, **UDP** = speed.
- **Encapsulation** ensures structured, interpretable data flow.