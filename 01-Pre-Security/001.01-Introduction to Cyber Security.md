...
- Analyse network and system security with various stakeholders.
...
- Test, monitor, and enhance software and network security systems.
...
- Develop and execute incident response plans and policies.
...
- Secure and process digital evidence while following legal standards.
...
- Perform **static analysis** (reverse-engineering code).
...
- Conduct controlled attacks on systems, networks, and applications.
...
- Emulate real-world adversaries to test defences and avoid detection.
- Evaluate security controls, intelligence, and incident response readiness.
- Deliver insights for strengthening resilience against targeted attacks.

## **Summary Insight:**

- These cybersecurity roles collectively form a defence ecosystem — **analysts** assess, **engineers** build, **responders** react, **forensic examiners** investigate, **malware analysts** dissect threats, **pentesters** expose weaknesses, and **red teamers** simulate real attackers to validate overall readiness.